...
export default function ViewedPage() {
    ...
    const fetchData = async () => {
            ...
            setMovies(moviesResponse.data.filter(movie => movie.status === 'viewed'));
            setSeries(seriesResponse.data.filter(series => series.status === 'viewed'));
            } catch (err) {
            ...
            <div className="flex flex-grow">
                    ...
                    {error && (
                        ...
                        <div className="text-center text-white">
                                        <p>No has visto ninguna película todavía.</p>
                        </div>
                                ) : (
                                    <>
                            ...
                            <div className={`transition-opacity duration-300 ${activeTab === 'series' ? 'opacity-100' : 'opacity-0 pointer-events-none absolute top-0 left-0 w-full'}`}>
                                {series.length === 0 ? (
                                    <div className="text-center text-white">
                                        <p>No has visto ninguna serie todavía.</p>
                                    </div>
                                ) : (
                                    <>
                                        <div className="grid grid-cols-3 gap-2 max-w-7xl mx-auto">
